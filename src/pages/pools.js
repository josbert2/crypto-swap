                    ...
                    <main>
                        <div class="header">
                            <div class="flex flex-col w-full">
                                ...
                                <div class="bg-gray-900 pl-9 pr-9 pb-9 pt-9 w-full flex flex-col-max align-items" style={{ background: "#191b20" }}>
                                    <h1 class="main-h1">Crypto Pools</h1>
                                    <div class="w-full md:w-auto md:ml-auto p-5 bg-gray-800 w-3/12">
                                ...
                                <div class="mt-1">
                                    <section class="text-gray-600 body-font">
                                        <div class="container px-5 py-5 mx-auto flex items-center md:flex-row flex-col">
                                            <div class="flex flex-col md:pr-10 md:mb-0 mb-6 pr-0 w-full md:w-auto md:text-left text-center hidden">
                                                <h2 class="text-xs text-indigo-500 tracking-widest font-medium title-font mb-1">ROOF PARTY POLAROID</h2>
                                                <h1 class="md:text-3xl text-2xl font-medium title-font text-gray-900">Master Cleanse Reliac Heirloom</h1>
                                            </div>
                                            <div class="flex w-full md:w-1/4 sm:flex-row flex-col ml-auto px-8 sm:space-x-4 sm:space-y-0 space-y-4 sm:px-0 items-end">
